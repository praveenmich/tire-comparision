...
server.registerTool(
  "process_tire_questionnaire",
  {
    description: "Processes user questionnaire...",
    inputSchema: {
  ...
  async (args) => {
    console.log("🛞 Processing tire questionnaire with args:", args);
    return {
      content: [{ type: "text", text: "Questionnaire received..." }],
